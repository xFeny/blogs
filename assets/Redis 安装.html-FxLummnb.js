import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as d,o as l,c as r,a as s,b as e,d as c,f as t,e as a}from"./app-kkGBRtIT.js";const o="/assets/image-8nGeedKr.png",p={},u=a(`<h1 id="redis-安装" tabindex="-1"><a class="header-anchor" href="#redis-安装" aria-hidden="true">#</a> Redis 安装</h1><h2 id="一、安装依赖" tabindex="-1"><a class="header-anchor" href="#一、安装依赖" aria-hidden="true">#</a> 一、安装依赖</h2><p>因为 Redis 是用C语言开发的，所以在安装之前需要确定是否安装gcc环境，如果没有安转可以执行一下命令进行安装</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>gcc <span class="token parameter variable">-v</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token parameter variable">-y</span> gcc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="二、下载安装" tabindex="-1"><a class="header-anchor" href="#二、下载安装" aria-hidden="true">#</a> 二、下载安装</h2>`,6),v={href:"http://download.redis.io/releases",target:"_blank",rel:"noopener noreferrer"},m=a(`<p>下载并解压</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> http://download.redis.io/releases/redis-6.2.6.tar.gz
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>测试客户端连接成功<br><img src="`+o+`" alt="" loading="lazy"></p><h3 id="_6、服务操作命令" tabindex="-1"><a class="header-anchor" href="#_6、服务操作命令" aria-hidden="true">#</a> 6、服务操作命令</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#启动redis服务</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,58);function b(h,g){const n=d("ExternalLinkIcon");return l(),r("div",null,[u,s("p",null,[e("Redis 版本："),s("a",v,[e("http://download.redis.io/releases"),c(n)])]),m,t(" ## 四、Redis 集群部署 ")])}const x=i(p,[["render",b],["__file","Redis 安装.html.vue"]]);export{x as default};
