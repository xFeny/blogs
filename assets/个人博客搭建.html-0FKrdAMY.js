import{_ as p}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as i,c,a as n,b as s,d as e,e as t}from"./app-xu5D-Dt8.js";const l={},u=t(`<h1 id="基于-vuepress-theme-hope-搭建个人博客" tabindex="-1"><a class="header-anchor" href="#基于-vuepress-theme-hope-搭建个人博客" aria-hidden="true">#</a> 基于 vuepress-theme-hope 搭建个人博客</h1><h2 id="一、创建项目模板" tabindex="-1"><a class="header-anchor" href="#一、创建项目模板" aria-hidden="true">#</a> 一、创建项目模板</h2><p>使用文件管理器打开对应文件夹，然后在上方的地址栏中输入 <code>cmd</code> 并按下回车。</p><img src="http://oss.feny.ink/blogs/images/202312291251097.png" alt="image-20231229125148053" style="zoom:80%;"><p>在终端中执行下列命令:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> init vuepress-theme-hope my-docs
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这里的 <code>my-docs</code> 是一个参数，代表 VuePress Theme Hope 项目的文件夹名称。</p><p>执行完命令后根据提示，通过键盘 <code>↓</code> 选择 <code>简体中文</code> 并回车来按需选择：</p><img src="http://oss.feny.ink/blogs/images/202312291302153.png" alt="image-20231229130212097" style="zoom:80%;"><h3 id="项目命令" tabindex="-1"><a class="header-anchor" href="#项目命令" aria-hidden="true">#</a> 项目命令</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 启动开发服务器</span>
