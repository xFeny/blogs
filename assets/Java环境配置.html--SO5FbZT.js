import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as i,e as n}from"./app-jEXVdZdQ.js";const d="/blogs/assets/image-UazS9iZA.png",l="/blogs/assets/image-2-cXuJC2io.png",s="/blogs/assets/image-3-xYq3SRG3.png",r="/blogs/assets/image-6-b126euE2.png",o="/blogs/assets/image-7-bsKb6sDd.png",t="/blogs/assets/image-9-9TWT_qw7.png",v="/blogs/assets/image-10-xbFWlb9M.png",c="/blogs/assets/image-8-AfNPcUlM.png",u={},m=n('<h1 id="java-jdk环境配置" tabindex="-1"><a class="header-anchor" href="#java-jdk环境配置" aria-hidden="true">#</a> Java JDK环境配置</h1><h2 id="windows环境下安装配置" tabindex="-1"><a class="header-anchor" href="#windows环境下安装配置" aria-hidden="true">#</a> Windows环境下安装配置</h2><h3 id="第一步-下载jdk并安装" tabindex="-1"><a class="header-anchor" href="#第一步-下载jdk并安装" aria-hidden="true">#</a> 第一步 下载JDK并安装</h3><p>下载好JDK exe文件直接双击，一直点下一步即可，安装成功后，我们开始进行java的环境变量配置</p><h3 id="第二步-配置环境变量" tabindex="-1"><a class="header-anchor" href="#第二步-配置环境变量" aria-hidden="true">#</a> 第二步 配置环境变量</h3><ol><li><p>首先找到jdk的安装目录，默认情况下在C:\\Program Files\\Java目录下</p></li><li><p>然后我们点击桌面“我的电脑”右键“属性”：<br><img src="'+d+'" alt="Alt text" loading="lazy"></p></li><li><p>点击“高级系统设置”：<br><img src="'+l+'" alt="Alt text" loading="lazy"></p></li><li><p>点击“环境变量”：<br><img src="'+s+'" alt="Alt text" loading="lazy"></p></li><li><p>在“系统变量”中新建一个，变量名：JAVA_HOME，变量值为JDK的安装路径。<br><img src="'+r+`" alt="Alt text" loading="lazy"></p></li><li><p>新建一个CLASSPATH路径，输入：</p></li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.;%JAVA_HOME%\\lib\\dt.jar;%JAVA_HOME%\\lib\\tools.jar
